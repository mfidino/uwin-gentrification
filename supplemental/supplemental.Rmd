...
header-includes:
- \usepackage{titling}
- \pretitle{\LARGE\includegraphics[width=12cm]{pnas_logo.png}\\[\bigskipamount]}
- \posttitle{}
...
\textbf{\Large{Supporting Information for}}\\
\Large{Gentrification drives patterns of alpha and beta diversity in cities}\\
\vspace{5truemm}
...
\vspace{5truemm}
Corresponding author: Mason Fidino\\
...
\begin{itemize}
  ...
  \vspace{-0.2cm}\item[] Multi-city Multi-species Occupancy Model Estimates (Tables S17 - S36)
    \vspace{-0.2cm}\item[] SI References  (\textit{1-9})
\end{itemize}
