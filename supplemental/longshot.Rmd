...
\begin{itemize}
  ...
  \vspace{-0.2cm}\item[] Alpha diversity model estimates (Table S10 - S12)
  \vspace{-0.2cm}\item[] Beta diversity model estimates (Table S13 - S15)
  \vspace{-0.2cm}\item[] Occupancy model estimates (Tables )
\end{itemize}
